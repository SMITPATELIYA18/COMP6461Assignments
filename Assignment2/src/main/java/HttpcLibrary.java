...
//            if (getHelper.getPostData().contains("'")) {
//                getHelper.setPostData(getHelper.getPostData().replace("'", ""));
//            }
//            if (getHelper.getPostData().equals("\"")) {
//                getHelper.setPostData(getHelper.getPostData().replace("'\"", ""));
//            }
//            writer.print("Content-Length: " + getHelper.getPostData()
...
//                postHelper.setPostData(postHelper.getPostData().replace("'\"", ""));
//            }
//            writer.print("Content-Length: " + postHelper.getPostData()
//                    .length() + NewLineCharacter);
...
//        if (postHelper.isInlineData()) {
//            writer.print(NewLineCharacter);
//            writer.print(postHelper.getPostData());
//            writer.print(NewLineCharacter);
//        } else if (postHelper.isFileSend()) {
//            writer.print(NewLineCharacter);
...
//                        redirectParameters.add(postHelper.getPostData());
//                    }
//                    redirectParameters.add("-h");
//                    redirectParameters.add("Keep-Alive:10");
//                    redirectParameters.add("-h");
